#include "paperUI_legacy.h"

#pragma region PaperUI_helpers

void PaperUI_legacy::__exportLayout()
{
...
void PaperUI_legacy::__exportJSON(std::string path)
{
...
void PaperUI_legacy::__importLayout()
{
...
void PaperUI_legacy::__importJSON(std::string path)
{
...
void PaperUI_legacy::_displayWindow()
{
	if (t_Display)
	{
...
void PaperUI_legacy::_widgetWindow()
{
	if (t_Widgets)
	{
...
void PaperUI_legacy::_propertyWindow()
{
	if (t_Property)
	{
